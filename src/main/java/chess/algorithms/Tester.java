...
public class Tester {
	...
	public static void main(String[] args) {
		...
		/*
		 * Follow the simple pattern bellow. NOTE: The default depth is 3.
		 * Setting the depth to 1 or 5 will only set it for the object used,
		 * which below is for MiniMax and not for any other algorithm.
		 * 
		 * ma.replay(true) - to reply for white ma.replay(false) - to reply for
		 * black
		 */
