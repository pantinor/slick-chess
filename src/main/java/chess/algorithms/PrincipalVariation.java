 ...
 * search where all nodes outside the principal variation are searched with a
 * minimal window beta = alpha + 1. The idea is that with perfect move ordering
 * all moves outside the principal variation will be worse than the principal
 * variation.
 * 
