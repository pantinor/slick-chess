...
/**
 * MiniMax, a subclass of MoveAlgorithm, is a MiniMax search algorithm. The
 * minimax strategy serves as the foundation of chess programs. It is a strategy
 * that minimizes the maximum risk for a player, going through all of the
 * branches in the move tree and evaluating the board position.
 * 
...
public class MiniMax extends MoveAlgorithm implements Serializable {
	 ...
	 *            - White player ?
	 * @param depth
	 *            - The current number of levels in the tree to be searched.
	 */
